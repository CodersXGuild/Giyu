import Giyu.modules.sql.locks_sql as sql
import html
import ast
...
from Giyu import dispatcher, THUNDERS, LOGGER
...
LOCK_TYPES = {
    ...
    | Filters.caption_entity(MessageEntity.SPOILER),
    "mention": Filters.entity(MessageEntity.MENTION)
    | Filters.caption_entity(MessageEntity.MENTION),
    "text_mention": Filters.entity(MessageEntity.TEXT_MENTION)
    | Filters.caption_entity(MessageEntity.TEXT_MENTION),
    "phone_number": Filters.entity(MessageEntity.PHONE_NUMBER)
    | Filters.caption_entity(MessageEntity.PHONE_NUMBER),
    "email": Filters.entity(MessageEntity.EMAIL)
    | Filters.caption_entity(MessageEntity.EMAIL),
