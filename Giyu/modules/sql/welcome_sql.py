...
from Giyu.modules.helper_funcs.msg_types import Types
from Giyu.modules.sql import BASE, SESSION
from sqlalchemy import Boolean, Column, String, UnicodeText, Integer
from sqlalchemy.sql.sqltypes import BigInteger

DEFAULT_WELCOME_MESSAGES = [
"( ꈍᴗꈍ) konnichiwa {first}."
]
   
DEFAULT_GOODBYE_MESSAGES = [
"{first} I'll Never Forgive You No Matter What!.",
"All {first} Did Was Memorize A Fact.Your Body Has No Clue What It Needs To Do. ~sabito.",
"If You Can Do One Thing, Hone It To Perfection.Hone It To The Utmost Limit. ~jigoro kuwajima.",
"Feel the rage, The powerful, pure rage of not being able to forgive will become your nunswerving drive to take action. ~Giyu Tomioka",
"Look straight ahead. Rouse yourself! Give it all you’ve got {first}!Give it all you’ve got!",
"{first} won the battle but lost the war!.",
"{first} is a man with no worth.",
"Yameeerroooooooooo!! {first}.",
]
...
def get_welc_pref(chat_id):
    ...
    if welc:
        ...
        # Welcome by default.
        return True, DEFAULT_WELCOME_MESSAGES, None, Types.TEXT 
