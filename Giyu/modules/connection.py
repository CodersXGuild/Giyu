...
import Giyu.modules.sql.connection_sql as sql
from Giyu import dispatcher, THUNDERS, FLAMES
from Giyu.modules.helper_funcs import chat_status
...
def connect_chat(update, context):
    ...
    if update.effective_chat.type == "private":
        if args and len(args) >= 1:
            ...
            if (isadmin) or (isallow and ismember) or (user.id in THUNDERS):
