...
from Water.ffmpegResource.convert import convert_gif 
    ...
    if msg.reply_to_message:
        ...
        edited_keyboard = InlineKeyboardMarkup(
            [
             [
              InlineKeyboardButton(
               text="Sticker", url=f"{packs}"),
             ],
             [
              InlineKeyboardButton(
               text="Video", url=f"https://t.me/addstickers/video{user.id}_by_{context.bot.username}"),
              InlineKeyboardButton(
               text="Animated", url=f"https://t.me/addstickers/animated{user.id}_by_{context.bot.username}"),
             ],
            ]
        )
        msg.reply_text(
...
•  `/mmf <img or sticker>`*:* Reply to a sticker or img your can make memeify sticker.
