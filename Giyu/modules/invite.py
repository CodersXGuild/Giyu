...
from Giyu.modules.helper_funcs.chat_status import user_can_restrict_no_reply, bot_admin
...
@GiyuCALLBACK(pattern=r"cb_approve=")
...
@GiyuCALLBACK(pattern=r"cb_decline=")
@user_can_restrict_no_reply
@bot_admin
@loggable
