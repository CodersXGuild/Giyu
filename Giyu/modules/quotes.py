...
from Giyu import quotly
from Water.quotelyResource.quotehelper import eor
...
async def quott_(event):
    ...
    if not event.is_reply:
        return await event.eor("Reply to a message baka")
    msg = await event.reply("`creating quote waitoo (~￣³￣)~...`")
