import html
import Giyu.modules.sql.blacklistusers_sql as sql
from Giyu import (
    FLAMES,
    OWNER_ID,
    CO_OWNER_ID,
...
BLACKLISTWHITELIST = [OWNER_ID, CO_OWNER_ID] + FLAMES + THUNDERS + BEASTS + WINDS
BLABLEUSERS = [OWNER_ID, CO_OWNER_ID] + FLAMES
