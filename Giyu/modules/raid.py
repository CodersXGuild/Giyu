...
from .helper_funcs.anonymous import  userr_admin, AdminPerms
from .helper_funcs.chat_status import bot_admin, connection_status, user_admin_no_reply
from .helper_funcs.decorators import GiyuCMD, GiyuCALLBACK
from .. import updater, LOGGER
...
@GiyuCMD(command="raid", pass_args=True)
@bot_admin
@connection_status
@loggable
...
@GiyuCALLBACK(pattern="enable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@GiyuCALLBACK(pattern="disable_raid=")
@connection_status
@user_admin_no_reply
@loggable
...
@GiyuCALLBACK(pattern="cancel_raid=")
@connection_status
@user_admin_no_reply
...
@GiyuCMD(command="raidactiontime", pass_args=True)
@connection_status
@userr_admin(AdminPerms.CAN_CHANGE_INFO)
@loggable
def raidtime(update: Update, context: CallbackContext) -> Optional[str]:
...
__help__ = """
Here is the help for the AntiRaid module:
