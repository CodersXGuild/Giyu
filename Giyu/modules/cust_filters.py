...
from Giyu import dispatcher, LOGGER, THUNDERS
...
from Giyu.modules.helper_funcs.extraction import extract_text
from Giyu.modules.helper_funcs.filters import CustomFilters
from Giyu.modules.helper_funcs.misc import build_keyboard_parser
from Giyu.modules.helper_funcs.msg_types import get_filter_type
...
from Giyu.modules.sql import cust_filters_sql as sql
from Giyu.modules.connection import connected
from Giyu.modules.helper_funcs.alternate import send_message, typing_action
...
def rmall_filters(update, context):
    ...
    if member.status != "creator" and user.id not in THUNDERS:
...
def rmall_callback(update, context):
    ...
    if query.data == "filters_rmall":
        if member.status == "creator" or query.from_user.id in THUNDERS:
