...
from Giyu import THUNDERS as SUDO_USERS
from Giyu import pbot
from Giyu.modules.sql import forceSubscribe_sql as sql
...
• Giyu can mute members who are not subscribed your channel until they subscribe
