...
from Giyu.modules.helper_funcs.decorators import GiyuCMD, GiyuCALLBACK
from Giyu.modules.helper_funcs.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from Giyu import EVENT_LOGS, LOGGER, dispatcher
    from Giyu.modules.helper_funcs.chat_status import user_admin as u_admin, is_user_admin
    from Giyu.modules.sql import log_channel_sql as sql
    ...
    @GiyuCMD(command='setlog')
    @userr_admin(AdminPerms.CAN_CHANGE_INFO)
        ...
        if chat.type == chat.CHANNEL:
            ...
            try:
                ...
                if excp.message == "Forbidden: bot is not a member of the channel chat":
                    ...
                    LOGGERexception("ERROR in setting the log channel.")
...
@GiyuCALLBACK(pattern=r"log_tog_.*")
