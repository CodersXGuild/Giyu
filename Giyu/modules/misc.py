...
from Giyu import StartTime
from Giyu.modules.helper_funcs.chat_status import sudo_plus
from Giyu.modules.helper_funcs.alternate import send_action, typing_action
...
•<code>||text||</code>: using || around text will create spoiler message and tap on it the text will be revealed.
